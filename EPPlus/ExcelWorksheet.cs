...
namespace OfficeOpenXml
{
    ...
    public class ExcelWorksheet : XmlHelper, IEqualityComparer<ExcelWorksheet>, IDisposable
    {
        ...
        public bool IsLoaded => _worksheetXml != null;
        ...
        internal override XmlNode TopNode
        {
            get
            {
                EnsureLoaded();
        ...
        internal bool SaveHandler(ZipOutputStream stream, CompressionLevel compressionLevel, string fileName)
        {
            if (!IsLoaded)
            {
                return false;
